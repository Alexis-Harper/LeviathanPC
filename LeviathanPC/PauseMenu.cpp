...
void PauseMenu::update (GameState &gameState, MainMenu &mainMenu, 
						Arena *activeArena, float windowResY, 
						float windowOffsets) 
{
	//X and Y ints
	int x, y;
	...
	//Update buttons
	if (this->menuButtons.continueGame.update (virtualX, virtualY, isPressed) 
		== true) 
	{
		gameState = GameState::GAME;
	}

	if (this->menuButtons.mainMenu.update (virtualX, virtualY, isPressed) == 
		true) 
	{
