...
void Input::update ()
{
	...
	if (controller)
	{
		...
		if (((joy0X * joy0X) + (joy0Y * joy0Y) <= M_PI / 16) && !up && 
			!right && !down && !left)
		{
			direction = NONE;
		}
...
bool Input::keyHeld (int index)
{
	return keyboard[index];
}


bool Input::buttonHeld (int index)
{
	return joyButton[index];
}


void Input::setDelta (double value)
{
	delta = value;
...
bool Input::controllerUsed ()
{
	return controller;
}


void Input::isControllerUsed (bool isUsed)
{
	controller = isUsed;
}


void Input::isHapticUsed (bool isUsed)
{
	haptic = isUsed;
}


void Input::joyButtonPressed (int index, bool value)
{
...
void Input::joyAxis0X (float value)
{
	joy0X = value;
...
void Input::joyAxis0Y (float value)
{
	joy0Y = value;
...
void Input::joyAxis1X (float value)
{
	joy1X = value;
...
void Input::joyAxis1Y (float value)
{
	joy1Y = value;
...
int Input::facingDirection ()
{
	return fdirection;
}


void Input::setHapticFeedback (SDL_Haptic *hapticPtr)
{
