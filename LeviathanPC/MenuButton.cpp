...
void MenuButton::render (GPU_Target *screen, SpriteSheet *buttonSheet, Font *font) {

	//Show button 
	buttonSheet->srender (screen, this->hitbox.getX (), this->hitbox.getY (), 1.0, 0, (this->selected == true ? 1 : 0));

	//Calculate rectangle to display text in
	NFont::Rectf textRect = Font::getRect_s (this->hitbox.getX (), this->hitbox.getY () + 0.02361111111f, 0.66666666666f, 0.04444444443f);

	//Display centered text
	font->getFont ()->drawBox (screen, textRect, NFont::AlignEnum::CENTER, this->displayedText);
